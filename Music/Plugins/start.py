...
def start_pannel():
    buttons = [
        [
            InlineKeyboardButton("Support", url=f"https://t.me/hiroshisupport"),
...
pstart_markup = InlineKeyboardMarkup(
    [
        ...
        [
            InlineKeyboardButton("sᴜᴘᴘʀᴏᴛ", url=f"https://t.me/hiroshisupport"),
            InlineKeyboardButton("ᴜᴘᴅᴀᴛᴇs", url=f"https://t.me/bombleebas"),
        ],
        [
            InlineKeyboardButton( 
